"""
Company Google Login — Separate from Candidate Google Login.
...
class CompanyGoogleLoginView(APIView):
    ...
    def post(self, request):
        """POST /api/v1/auth/company/google/  Body: { id_token }"""
        ...
        try:
            ...
            try:
                ...
                user = CompanyUser(email=email, full_name=name, is_email_verified=True, is_active=True)
